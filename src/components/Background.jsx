const BADGES = [
  {
    id: 1, name: 'React', sub: 'v19.0',
    color: '#0369a1', bg: 'rgba(14,165,233,0.12)', border: 'rgba(14,165,233,0.2)',
    style: { top: '8%', left: '3%' },
    dur: '7s', delay: '0s', lift: '-16px', rot: '-1deg', rot2: '1.5deg',
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="#0ea5e9">
        <ellipse cx="12" cy="12" rx="10" ry="4" fill="none" stroke="#0ea5e9" strokeWidth="1.2"/>
        <ellipse cx="12" cy="12" rx="10" ry="4" fill="none" stroke="#0ea5e9" strokeWidth="1.2" transform="rotate(60 12 12)"/>
        <ellipse cx="12" cy="12" rx="10" ry="4" fill="none" stroke="#0ea5e9" strokeWidth="1.2" transform="rotate(120 12 12)"/>
        <circle cx="12" cy="12" r="2" fill="#0ea5e9"/>
      </svg>
    ),
  },
  {
    id: 2, name: 'Node.js', sub: 'Runtime',
    color: '#15803d', bg: 'rgba(16,185,129,0.1)', border: 'rgba(16,185,129,0.2)',
    style: { top: '6%', right: '8%' },
  ...
  {
    id: 3, name: 'GitHub', sub: 'API v4',
    color: '#0c4a6e', bg: 'rgba(14,165,233,0.08)', border: 'rgba(14,165,233,0.15)',
    style: { top: '40%', left: '2%' },
  ...
  {
    id: 4, name: 'TypeScript', sub: 'Strict',
    color: '#0369a1', bg: 'rgba(14,165,233,0.1)', border: 'rgba(14,165,233,0.2)',
  ...
  {
    id: 5, name: 'Dev.to', sub: 'Articles',
    color: '#0369a1', bg: 'rgba(14,165,233,0.08)', border: 'rgba(14,165,233,0.15)',
  ...
  {
    id: 6, name: 'Vite', sub: 'Build tool',
    color: '#15803d', bg: 'rgba(16,185,129,0.08)', border: 'rgba(16,185,129,0.15)',
  ...
  {
    id: 8, name: 'Supabase', sub: 'Auth + DB',
    color: '#15803d', bg: 'rgba(16,185,129,0.08)', border: 'rgba(16,185,129,0.15)',
    style: { bottom: '22%', right: '16%' },
    dur: '8.5s', delay: '-1.5s', lift: '-16px', rot: '-1deg', rot2: '1deg',
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="#10b981">
        <path d="M11.9 1.036c-.015-.986-1.26-1.41-1.874-.637L.764 12.05C.34 12.5.63 13.22 1.26 13.22h9.61l.03 9.746c.015.985 1.26 1.41 1.874.637l9.262-11.652c.424-.45.135-1.17-.492-1.17h-9.61L11.9 1.036z"/>
      </svg>
    ),
  },
]
...
function FloatingBadge({ badge }) {
  ...
  return (
    ...
    >
      <div className="float-badge-icon" style={{ background: bg }}>{icon}</div>
      <div>
        <div className="float-badge-name" style={{ color }}>{name}</div>
        <div className="float-badge-sub">{sub}</div>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="bg-scene">
      ...
      {BADGES.map(function(badge) {
        return <FloatingBadge key={badge.id} badge={badge} />
      })}
    </div>
  )
}
