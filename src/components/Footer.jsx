  ...
  return (
    <footer className="footer">
      <div className="footer-inner">
        ...
        <div className="footer-brand">
          ...
          <p className="footer-tagline">
            Ta veille tech en temps réel — GitHub, Dev.to, Hacker News, centralisés.
          </p>
          <div className="footer-socials">
            <a href="https://github.com/abidinetou-lgtm" target="_blank" rel="noopener noreferrer" className="footer-social-btn" title="GitHub">
            ...
            <a href="https://www.linkedin.com/in/jimel-abidine-toure-56007139a" target="_blank" rel="noopener noreferrer" className="footer-social-btn" title="LinkedIn">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            ...
            <li><Link to="/dashboard">Veille</Link></li>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            <li>
              <a href="mailto:jimeltoure@gmail.com">
                ...
                jimeltoure@gmail.com
              </a>
            </li>
            <li>
              <a href="mailto:jimelabidinetoure@gmail.com">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{marginRight:6,verticalAlign:'middle'}}>
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                  <polyline points="22,6 12,13 2,6"/>
                </svg>
                jimelabidinetoure@gmail.com
              </a>
            </li>
            <li>
              <a href="tel:+33769684001">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{marginRight:6,verticalAlign:'middle'}}>
            ...
            <li>
              <a href="https://github.com/abidinetou-lgtm" target="_blank" rel="noopener noreferrer">
                github.com/abidinetou-lgtm
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <span>© 2025 CodePulse — Jimel Abidine Touré</span>
        <span>Construit avec React · Node.js · Supabase · Vercel</span>
      </div>
    </footer>
  )
}
